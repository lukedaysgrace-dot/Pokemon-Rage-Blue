...
; --- Bruno ---
; Onix L53
db BRUNO, 1, 1, ROCK_THROW, DIG, SLAM, HARDEN
; Hitmonchan L55
db BRUNO, 1, 2, ICE_PUNCH, THUNDERPUNCH, MEGA_PUNCH, COUNTER
; Hitmonlee L55
db BRUNO, 1, 3, JUMP_KICK, OUTRAGE, HI_JUMP_KICK, MEGA_KICK
; Onix L56
db BRUNO, 1, 4, ROCK_THROW, DIG, SLAM, HARDEN
; Machamp L58
db BRUNO, 1, 5, LEER, OUTRAGE, FISSURE, SUBMISSION
...
; Steelix L58
db BRUNO, 2, 1, ROCK_SLIDE, EARTHQUAKE, SLAM, HARDEN
; Hitmonchan L58
db BRUNO, 2, 2, ICE_PUNCH, THUNDERPUNCH, MEGA_PUNCH, COUNTER
; Hitmonlee L58
db BRUNO, 2, 3, JUMP_KICK, OUTRAGE, HI_JUMP_KICK, MEGA_KICK
; Rhyperior L58
db BRUNO, 2, 4, ROCK_SLIDE, EARTHQUAKE, FISSURE, BODY_SLAM
; Machamp L58
db BRUNO, 2, 5, BODY_SLAM, OUTRAGE, FISSURE, SUBMISSION
; Annihilape L58
db BRUNO, 2, 6, SHADOW_BALL, OUTRAGE, SUBMISSION, COUNTER
