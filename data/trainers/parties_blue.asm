...
; Post-Champion rematch (wTrainerNo 2)
	db $FF, 55, GOLEM, 55, KABUTOPS, 55, OMASTAR, 55, RHYDON, 55, AERODACTYL, 55, ONIX, 0
MistyData:
...
AgathaData:
	db $FF, 52, GENGAR, 47, MISMAGIUS, 48, MIMIKYU, 46, DUSCLOPS, 48, DUSKNOIR, 48, GOLURK, 0
; Post-Champion rematch (wTrainerNo 2)
	db $FF, 60, GENGAR, 60, MISMAGIUS, 60, MIMIKYU, 60, DUSCLOPS, 60, DUSKNOIR, 60, GOLURK, 0
LanceData:
