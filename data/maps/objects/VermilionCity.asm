	...
	const_export VERMILIONCITY_GUARD
	const_export VERMILIONCITY_SQUIRTLE
...
VermilionCity_Object:
	...
	object_event 20, 15, SPRITE_GUARD, STAY, DOWN, TEXT_VERMILIONCITY_GUARD
	object_event 19, 15, SPRITE_SQUIRTLE, STAY, RIGHT, TEXT_VERMILIONCITY_SQUIRTLE
