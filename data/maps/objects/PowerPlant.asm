...
PowerPlant_Object:
	...
	; Only two distinct 4-tile "still" sprites fit in VRAM per map. VOLTORB +
	; POKE_BALL use both, so the Electrodes reuse the VOLTORB sprite; using
	; SPRITE_ELECTRODE here made them render as plain Poke Balls.
	def_object_events
	...
	object_event 25, 18, SPRITE_VOLTORB, STAY, NONE, TEXT_POWERPLANT_ELECTRODE1, ELECTRODE, 43
	...
	object_event 21, 14, SPRITE_VOLTORB, STAY, NONE, TEXT_POWERPLANT_ELECTRODE2, ELECTRODE, 43
