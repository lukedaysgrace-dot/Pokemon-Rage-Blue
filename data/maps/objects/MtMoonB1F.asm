...
MtMoonB1F_Object:
	...
	def_object_events
	object_event  4,  4, SPRITE_FOSSIL, STAY, NONE, TEXT_MTMOONB1F_JAW_FOSSIL, JAW_FOSSIL
	object_event 24,  8, SPRITE_FOSSIL, STAY, NONE, TEXT_MTMOONB1F_SAIL_FOSSIL, SAIL_FOSSIL
