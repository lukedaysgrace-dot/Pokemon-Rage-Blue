SeafoamIslandsB1F_Script:
	...
	ld de, TOGGLE_SEAFOAM_ISLANDS_B1F_BOULDER_1 ; object to hide
	ld bc, TOGGLE_SEAFOAM_ISLANDS_B2F_BOULDER_1 ; object to show
...
.boulder2FellDownHole
	...
	ld de, TOGGLE_SEAFOAM_ISLANDS_B1F_BOULDER_2 ; object to hide
	ld bc, TOGGLE_SEAFOAM_ISLANDS_B2F_BOULDER_2 ; object to show
